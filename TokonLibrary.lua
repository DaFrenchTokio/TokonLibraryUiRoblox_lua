...
function library:SpawnMain(titlemain)
    function library:notification(title, msg)
    ...
    Back.Position = UDim2.new(0.180000007, 0, 0.25, 0)
    ...
    function WNFQCPK_fake_script() -- Close_Button.LocalScript 
    ...
    function libraryfunctions:SpawnToggle(toggle_title, category_name, toggle_state)
        ...
        if category_location then
            ...
            if main.num == 0 then
                ...
                main.pos = 1 * main.num 
                Position = UDim2.new(-1.58, 0, main.pos + 1, 0)
            end
