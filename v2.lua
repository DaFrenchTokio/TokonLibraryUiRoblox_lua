...
function Library_Tokon:SpawnMain(titlemain)
    ...
    game.Players.LocalPlayer:GetMouse().KeyDown:Connect(function(key)
        if key:lower() == "v" then
            Back.Visible = true
            Back:TweenPosition(UDim2.new(0.18, 0, 0.25, 0))
        end
    end)
    ...
    coroutine.wrap(OOBCW_fake_script)()
            ...
            function geton()
                ...
                script.Parent.MouseButton1Click:Connect(function()
                    local main = {
                        ...
                        center = script.Parent.Parent.Parent.Intern.Center,
                        count = 2
                    }
                    for i,v in pairs(main.center:GetChildren()) do
                        if v:IsA('TextLabel') then
                            v.Visible = false
                        end
                    end
                    main.intern.CanvasSize = UDim2.new(0, 0, 2, 0)
                    local check = main.center:FindFirstChild(Category.Name)
                    if check then
    ...
    function libraryfunctions:SpawnToggle(toggle_title, category_name, toggle_state)
        ...
        local category_location = Center:FindFirstChild(category_name)
        local main = {
            num = 0,
            pos = 0
        }
        if category_location then
            ...
            if main.num == 0 then
                Frame.Position = UDim2.new(-1.46, 0, 1.28, 0)
            else
                main.pos = 1.28 + (1 * main.num)
                Frame.Position = UDim2.new(-1.46, 0, main.pos, 0)
            end
    ...
    function libraryfunctions:SpawnButton(button_title, category_name, button_function)
        ...
        if category_location then
            ...
            if num == 0 then
                TextButton.Position = UDim2.new(-1.46, 0, 1.28, 0)
            else
                pos = 1.28 + (1 * num)
                TextButton.Position = UDim2.new(-1.46, 0, pos, 0)
            end
    ...
    function libraryfunctions:SpawnText(label_text, category_name)
        local category_location = Center:FindFirstChild(category_name)
        ...
        if category_location then
            ...
            if num == 0 then
                Label.Position = UDim2.new(-1.46, 0, 1.28, 0)
            else
                pos = 1.28 + (1 * num)
                Label.Position = UDim2.new(-1.46, 0, pos, 0)
            end
            Label.Parent = category_location
            Label.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            Label.BorderColor3 = Color3.fromRGB(99, 99, 99)
            Label.Size = UDim2.new(0, 400, 0, 40)
            Label.Font = Enum.Font.SourceSans
            Label.Text = ""
            Label.TextColor3 = Color3.fromRGB(0, 0, 0)
            Label.TextSize = 14.000
            Label.Name = main.button_name
            UICorner.Parent = Label
            Title.Name = "label_text"
            Title.Position = UDim2.new(0.055,0,0,0)
            Title.Parent = Label
            Title.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            Title.BackgroundTransparency = 1.000
    ...
    function libraryfunctions:SpawnSlider(slider_title, category_name, startnumber, endnumber)
        ...
        if category_location then
            ...
            if num == 0 then
                ...
                pos = 1.28 + (1 * num)
                Frame.Position = UDim2.new(-1.46, 0, pos, 0)
            end
            Frame.Parent = category_location
            Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            Frame.Size = UDim2.new(0, 400, 0, 40)
            ...
            MainFrame.Position = UDim2.new(0.577499986, 0, 0.37500003, 0)
            MainFrame.Size = UDim2.new(0, 150, 0, 10)
            UICorner_2.CornerRadius = UDim.new(0, 25)
            UICorner_2.Parent = MainFrame
            MainSlider.Name = "MainSlider"
            MainSlider.Parent = MainFrame
            MainSlider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            MainSlider.BorderColor3 = Color3.fromRGB(60, 60, 60)
            MainSlider.Position = UDim2.new(3.7252903e-09, 0, -0.949999928, 0)
            MainSlider.Size = UDim2.new(0, 5, 0, 28)
            ...
            Title_2.Position = UDim2.new(-0.52, 0, -1.5, 0)
            Title_2.Size = UDim2.new(0, 55, 0, 40)
            Title_2.Font = Enum.Font.SourceSans
            Title_2.Text = tostring(startnumber)
